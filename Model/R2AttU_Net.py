...
class AttU_Net(nn.Module, CardioCascadeNet.MetaParameters):
...
class R2AttU_Net(nn.Module, CardioCascadeNet.MetaParameters):
    def __init__(self, t = 2):
        ...
        self.RRCNN1 = RRCNN_block(ch_in = in_channels, ch_out = features, t = t)
    ...
    def forward(self,x):
        ...
        return torch.softmax(self.Conv_1x1(d2), dim=1)
